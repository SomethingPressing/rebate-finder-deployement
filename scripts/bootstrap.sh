...
# STEP 2 — System user
# ═════════════════════════════════════════════════════════════════════════════
log "Step 2/12 — System user '$APP_USER'"
...
# ═════════════════════════════════════════════════════════════════════════════
log "Step 3/12 — GitHub SSH deploy keys"
...
# ═════════════════════════════════════════════════════════════════════════════
log "Step 5/12 — Add public keys to GitHub"
...
# ═════════════════════════════════════════════════════════════════════════════
log "Step 6/12 — Verify GitHub connections"
...
# ═════════════════════════════════════════════════════════════════════════════
log "Step 7/12 — Clone deployment repo"
...
# ═════════════════════════════════════════════════════════════════════════════
log "Step 11/12 — Nginx reverse proxy (port 80 → localhost:3000)"

# SKIP_SSL=true — bootstrap handles SSL itself in step 12
APP_DOMAIN="$APP_DOMAIN" SKIP_SSL=true bash "$SCRIPT_DIR/setup-nginx.sh"

# ═════════════════════════════════════════════════════════════════════════════
# STEP 12 — SSL / Let's Encrypt
# ═════════════════════════════════════════════════════════════════════════════
log "Step 12/12 — SSL / Let's Encrypt"
